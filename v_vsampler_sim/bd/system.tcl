...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net video_down_sample_0_m_axis_tuser [get_bd_ports tuser] [get_bd_pins video_down_sample_0/m_axis_tuser]
  connect_bd_net -net video_down_sample_0_m_axis_tvalid [get_bd_ports tvalid] [get_bd_pins video_down_sample_0/m_axis_tvalid]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs v_tpg_0/s_axi_CTRL/Reg] -force
